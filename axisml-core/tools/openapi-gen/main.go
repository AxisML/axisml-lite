...
// System services expose, plus its own probes and aggregate capability endpoint.
// The composite spec is the UNION of the Lite-owned surface (built here by
// reflection over pkg/core) and the three System surfaces.
//
...
// axisml-core library module that external projects embed: pkg/core consumes only
// the generated bytes it embeds, never the reflection generator. Run from the
// tools module root:
//
//	go run ./openapi-gen -o ../../docs/apis/axisml-core.yaml -embed ../pkg/core/openapi.gen.yaml
package main
...
func main() {
	...
	// Both destinations get the identical bytes: the canonical docs/apis copy and
	// the in-package copy pkg/core embeds.
