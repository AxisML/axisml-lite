...
from ...models.patch_resource_unit_request import PatchResourceUnitRequest
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        pool (str):
        unit (str):
        body (PatchResourceUnitRequest):  Example: {'description': '2× A100 GPU compute unit
            (updated).', 'limits': {'cpu': '24', 'memory': '192Gi', 'nvidia.com/gpu': '2'}}.
