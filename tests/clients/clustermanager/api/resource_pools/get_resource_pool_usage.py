...
from ...models.pool_usage import PoolUsage
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/resourcepools/{pool}/usage".format(
...
) -> ClusterManagerError | PoolUsage:
    if response.status_code == 200:
        response_200 = PoolUsage.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ClusterManagerError | PoolUsage]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a tenant's used-vs-total resource utilisation in the pool
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    tenant: str,
) -> ClusterManagerError | PoolUsage | None:
    """Get a tenant's used-vs-total resource utilisation in the pool
