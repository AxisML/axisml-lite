...
class PatchQuotaRequest:
    """
    Example:
        {'quota': {'max': {'nvidia.com/gpu': '8'}, 'min': {'cpu': '32', 'memory': '256Gi'}}}

    Attributes:
        quota (None | ServerQuotaResources | Unset): Replacement direct min/max resources for the pool quota. Mutually
            exclusive with units.
        units (list[ServerQuotaUnit] | Unset): Replacement unit × quantity selections for the pool quota. Mutually
