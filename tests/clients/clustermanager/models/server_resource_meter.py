...
T = TypeVar("T", bound="ServerResourceMeter")


@_attrs_define
class ServerResourceMeter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server_resource_meter.additional_properties = d
        return server_resource_meter
