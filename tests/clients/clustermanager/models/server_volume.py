...
if TYPE_CHECKING:
    from ..models.server_volume_labels import ServerVolumeLabels
    from ..models.server_volume_status import ServerVolumeStatus


T = TypeVar("T", bound="ServerVolume")
...
class ServerVolume:
    ...
    Attributes:
        ...
        labels (ServerVolumeLabels | Unset): User-defined labels on the volume.
    ...
    labels: ServerVolumeLabels | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        labels: ServerVolumeLabels | Unset
        if isinstance(_labels, Unset):
            labels = UNSET
        else:
            labels = ServerVolumeLabels.from_dict(_labels)
        ...
        server_volume.additional_properties = d
