...
if TYPE_CHECKING:
    from ..models.server_volume_mount import ServerVolumeMount


T = TypeVar("T", bound="ServerVolumeStatus")


@_attrs_define
class ServerVolumeStatus:
    """
    Attributes:
        bound_capacity (str | Unset): Actually bound capacity once the volume is Bound.
        mounts (list[ServerVolumeMount] | Unset): Workloads currently mounting this volume (populated on detail get).
    ...
    mounts: list[ServerVolumeMount] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _mounts is not UNSET:
            ...
            for mounts_item_data in _mounts:
                mounts_item = ServerVolumeMount.from_dict(mounts_item_data)
        ...
        server_volume_status.additional_properties = d
        return server_volume_status
