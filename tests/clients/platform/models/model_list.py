...
class ModelList:
    """
    Example:
        {'continueToken': '', 'count': 1, 'items': [{'createdAt': '2026-06-20T08:00:00Z', 'description': 'ResNet-50
            weights fine-tuned on ImageNet.', 'digest':
            ...
            'uri': 'oci://registry.axisml.io/team-vision/resnet50:1.4.0', 'version': '1.4.0'}], 'partial': False}

    Attributes:
        count (int): Number of model versions in this page.
        items (list[Model]): Model versions in this page.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = Model.from_dict(items_item_data)
