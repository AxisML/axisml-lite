...
from ...models.experiment_patch_request import ExperimentPatchRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/experiments/{name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (ExperimentPatchRequest):  Example: {'description': 'Updated description.',
