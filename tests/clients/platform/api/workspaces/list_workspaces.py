...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Problem | WorkspaceList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        owner (str | Unset):
        phase (WorkspacePhase | Unset): Derived from compute service phase + replicas. Hoisted to
            the top of Workspace for B-tree filtering.
        q (str | Unset):
        limit (int | Unset):
        continue_ (str | Unset):
