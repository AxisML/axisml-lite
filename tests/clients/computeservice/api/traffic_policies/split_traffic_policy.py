...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/namespaces/{namespace}/traffic-policies/{policy}/split".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Adjust per-backend weights

    Args:
        namespace (str):
        policy (str):
        body (TrafficPolicySplitRequest):  Example: {'backends': [{'serviceName': 'llama3-8b',
            'weight': 80}, {'serviceName': 'llama3-8b-v2', 'weight': 20}]}.
