...
from ...models.ml_run_list import MLRunList
...
) -> ComputeServiceError | MLRunList:
    if response.status_code == 200:
        response_200 = MLRunList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ComputeServiceError | MLRunList]:
    return Response(
...
def sync(
    ...
    *,
    ...
    continue_: str | Unset = UNSET,
    label_selector: str | Unset = UNSET,
) -> ComputeServiceError | MLRunList | None:
    """List MLRuns in a namespace
