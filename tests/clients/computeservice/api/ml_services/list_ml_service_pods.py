...
from ...models.pod_list import PodList
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/namespaces/{namespace}/mlservices/{mlservice}/pods".format(
...
) -> ComputeServiceError | PodList:
    if response.status_code == 200:
        response_200 = PodList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ComputeServiceError | PodList]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> ComputeServiceError | PodList | None:
    """List pods of an MLService
