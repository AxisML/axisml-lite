...
T = TypeVar("T", bound="MLServicePhaseList")


@_attrs_define
class MLServicePhaseList:
    """
    Attributes:
        count (int): Number of items returned in this page (len(items)).
        items (list[MLServicePhase]): The page of items for the current offset.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = MLServicePhase.from_dict(items_item_data)
        ...
        ml_service_phase_list.additional_properties = d
        return ml_service_phase_list
