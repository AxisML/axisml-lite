...
T = TypeVar("T", bound="Corev1ConfigMapProjection")


@_attrs_define
class Corev1ConfigMapProjection:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        corev_1_config_map_projection = cls(
            items=items,
            name=name,
            optional=optional,
        )

        corev_1_config_map_projection.additional_properties = d
        return corev_1_config_map_projection
