...
if TYPE_CHECKING:
    ...
    from ..models.ml_service_scheduling_node_selector import (
        MLServiceSchedulingNodeSelector,
    )


T = TypeVar("T", bound="MLServiceScheduling")


@_attrs_define
class MLServiceScheduling:
    """
    Attributes:
        quota (str):
        node_selector (MLServiceSchedulingNodeSelector | Unset):
        priority_class (str | Unset):
        tolerations (list[Corev1Toleration] | Unset):
    """

    quota: str
    node_selector: MLServiceSchedulingNodeSelector | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_node_selector, Unset):
            ...
            node_selector = MLServiceSchedulingNodeSelector.from_dict(_node_selector)
        ...
        ml_service_scheduling.additional_properties = d
        return ml_service_scheduling
