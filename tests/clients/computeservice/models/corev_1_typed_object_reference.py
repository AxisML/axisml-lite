...
T = TypeVar("T", bound="Corev1TypedObjectReference")


@_attrs_define
class Corev1TypedObjectReference:
    """
    Attributes:
        kind (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        corev_1_typed_object_reference = cls(
            kind=kind,
            name=name,
            api_group=api_group,
            namespace=namespace,
        ...
        corev_1_typed_object_reference.additional_properties = d
        return corev_1_typed_object_reference
