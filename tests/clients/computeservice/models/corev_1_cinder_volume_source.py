...
T = TypeVar("T", bound="Corev1CinderVolumeSource")


@_attrs_define
class Corev1CinderVolumeSource:
    """
    Attributes:
        volume_id (str):
        fs_type (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        corev_1_cinder_volume_source = cls(
            volume_id=volume_id,
            fs_type=fs_type,
            read_only=read_only,
        ...
        corev_1_cinder_volume_source.additional_properties = d
        return corev_1_cinder_volume_source
