...
if TYPE_CHECKING:
    ...
    from ..models.ml_service_pod_port import MLServicePodPort


T = TypeVar("T", bound="MLServicePodTemplate")


@_attrs_define
class MLServicePodTemplate:
    """
    Attributes:
        image (str):
        args (list[str] | Unset):
        ...
        ports (list[MLServicePodPort] | Unset):
    ...
    ports: list[MLServicePodPort] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _ports is not UNSET:
            ...
            for ports_item_data in _ports:
                ports_item = MLServicePodPort.from_dict(ports_item_data)
        ...
        ml_service_pod_template.additional_properties = d
        return ml_service_pod_template
